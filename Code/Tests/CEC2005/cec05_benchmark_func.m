function [f,lb,ub]=benchmark_func(x,func_num)
global initial_flag 
...
if initial_flag==0
    if func_num==1 fhd=str2func('sphere_func'); lb=-100; ub=100; %[-100,100]
    elseif func_num==2 fhd=str2func('schwefel_102');lb=-100; ub=100; %[-100,100]
    elseif func_num==3 fhd=str2func('high_cond_elliptic_rot_func');lb=-100; ub=100; %[-100,100]
    elseif func_num==4 fhd=str2func('schwefel_102_noise_func');lb=-100; ub=100; %[-100,100]
    elseif func_num==5 fhd=str2func('schwefel_206'); lb=-100; ub=100;  %[no bound],initial[-100,100];
    elseif func_num==6 fhd=str2func('rosenbrock_func');lb=-100; ub=100; %[-100,100]
    elseif func_num==7 fhd=str2func('griewank_rot_func');lb=-600; ub=600; %[-600,600]
    elseif func_num==8 fhd=str2func('ackley_rot_func');lb=-32; ub=32; %[-32,32]
    elseif func_num==9 fhd=str2func('rastrigin_func');lb=-5; ub=5; %[-5,5]
    elseif func_num==10 fhd=str2func('rastrigin_rot_func');lb=-5; ub=5; %[-5,5]
    elseif func_num==11 fhd=str2func('weierstrass_rot');lb=-0.5; ub=0.5; %[-0.5,0.5]
    elseif func_num==12 fhd=str2func('schwefel_213');lb=-pi; ub= pi; %[-pi,pi]
    elseif func_num==13 fhd=str2func('EF8F2_func');lb=-3; ub=1; %[-3,1] 
    elseif func_num==14 fhd=str2func('E_ScafferF6_func');lb=-100; ub=100; %[-100,100]
    elseif func_num==15 fhd=str2func('hybrid_func1');lb=-5; ub=5; %[-5,5]
    elseif func_num==16 fhd=str2func('hybrid_rot_func1');lb=-5; ub=5; %[-5,5]
    elseif func_num==17 fhd=str2func('hybrid_rot_func1_noise');lb=-5; ub=5; %[-5,5]        
    elseif func_num==18 fhd=str2func('hybrid_rot_func2');lb=-5; ub=5; %[-5,5]    
    elseif func_num==19 fhd=str2func('hybrid_rot_func2_narrow');lb=-5; ub=5; %[-5,5]    
    elseif func_num==20 fhd=str2func('hybrid_rot_func2_onbound');lb=-5; ub=5; %[-5,5]  
    elseif func_num==21 fhd=str2func('hybrid_rot_func3');lb=-5; ub=5; %[-5,5]    
    elseif func_num==22 fhd=str2func('hybrid_rot_func3_highcond');lb=-5; ub=5; %[-5,5]  
    elseif func_num==23 fhd=str2func('hybrid_rot_func3_noncont');lb=-5; ub=5; %[-5,5]   
    elseif func_num==24 fhd=str2func('hybrid_rot_func4');lb=-5; ub=5; %[-5,5]  
    elseif func_num==25 fhd=str2func('hybrid_rot_func4');lb=-5; ub=5; %[-5,5]  
    end
    load fbias_data;
end
